...
trait HtmlRendererTrait
{
    ...
    private function renderTemplate(string $templateName, array $context = []): string //o array inicia como =[] pois ele é um parametro opcional, ou seja, não tem variável nenhuma
    {
